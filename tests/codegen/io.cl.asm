...
Aclase: .word Objectclase,f5,f6,f2,f4,f7
...
Bclase: .word Aclase,f21,f22,f2,f4,f7,f23
Cclase: .word IOclase,f24,f25,f2,f4,f10,f11,f12,f13,f26
Mainclase: .word IOclase,f27,f28,f2,f4,f10,f11,f12,f13,f29
Dclase: .word Cclase,f30,f31,f2,f4,f10,f11,f12,f13,f26,f32
.text
.globl main
main:
addi $sp ,$sp, -4
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var61<-['Main', '$init']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a0, 0($sp)
addi $sp, $sp, 4
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var62<-['Main', 'main']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a0, 0($sp)
addi $sp, $sp, 4
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var13<-['IO', 'out_string']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a1, 0($sp)
lw $a0, 4($sp)
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var36<-['IO', 'out_string']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a1, 0($sp)
lw $a0, 4($sp)
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var44<-['C', 'out_string']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a1, 0($sp)
lw $a0, 4($sp)
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var60<-['Main', 'out_string']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a1, 0($sp)
lw $a0, 4($sp)
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var68<-['D', 'out_string']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a1, 0($sp)
lw $a0, 4($sp)
