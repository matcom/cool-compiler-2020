...
addi $sp, $sp, -4
sw $ra, 0($sp)
jal $t0 #var.var32<-['String', 'length']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a0, 0($sp)
addi $sp, $sp, 4
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jal $t0 #var.var40<-['String', 'substr']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a2, 0($sp)
lw $a1, 4($sp)
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jal $t0 #var.var43<-['String', 'length']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a0, 0($sp)
addi $sp, $sp, 4
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jal $t0 #var.var48<-['String', 'substr']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a2, 0($sp)
lw $a1, 4($sp)
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jal $t0 #var.var55<-['String', 'length']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a0, 0($sp)
addi $sp, $sp, 4
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jal $t0 #var.var59<-['String', 'substr']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a2, 0($sp)
lw $a1, 4($sp)
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var72<-['Main', 'out_string']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a1, 0($sp)
lw $a0, 4($sp)
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var75<-['Main', 'in_string']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a0, 0($sp)
addi $sp, $sp, 4
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var82<-['Main', 'out_string']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a1, 0($sp)
lw $a0, 4($sp)
