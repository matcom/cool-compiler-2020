...
Complexclase: .word IOclase,f21,f22,f2,f4,f7,f8,f9,f10,f23,f24,f25,f26,f27
.text
.globl main
main:
addi $sp ,$sp, -4
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var32<-['Complex', 'reflect_Y']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a0, 0($sp)
addi $sp, $sp, 4
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var34<-['Complex', 'reflect_0']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a0, 0($sp)
addi $sp, $sp, 4
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var42<-['Main', 'out_string']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a1, 0($sp)
lw $a0, 4($sp)
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var39<-['Main', 'out_string']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a1, 0($sp)
lw $a0, 4($sp)
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var70<-['Complex', 'out_int']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a1, 0($sp)
lw $a0, 4($sp)
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var72<-['Complex', 'out_string']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a1, 0($sp)
lw $a0, 4($sp)
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var74<-['Complex', 'out_int']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a1, 0($sp)
lw $a0, 4($sp)
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var76<-['Complex', 'out_string']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a1, 0($sp)
lw $a0, 4($sp)
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var67<-['Complex', 'out_int']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a1, 0($sp)
lw $a0, 4($sp)
