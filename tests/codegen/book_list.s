.data
	...
	classname_IO: .align 2 
			.asciiz "IO"
	classname_Book: .align 2 
			.asciiz "Book"
	classname_Article: .align 2 
			.asciiz "Article"
	classname_BookList: .align 2 
			.asciiz "BookList"
...
function_build_class_name_table:
	...
	la $t1 classname_IO
	sw $t1 8($s1)
	la $t1 classname_Book
	sw $t1 12($s1)
	la $t1 classname_Article
	sw $t1 16($s1)
	la $t1 classname_BookList
	sw $t1 20($s1)
...
function_build_dispatch_tables:
	...
	la $t1 function_IO_out_string
	sw $t1 24($v0)
	la $t1 function_Book_initBook
	sw $t1 28($v0)
	la $t1 function_Book_print
	sw $t1 32($v0)
	lw $t0 24($s0)
	sw $v0 8($t0)
	...
	la $t1 function_Book_print
	sw $t1 32($v0)
	la $t1 function_Article_initArticle
	sw $t1 36($v0)
	la $t1 function_Article_print
	sw $t1 40($v0)
	lw $t0 32($s0)
	sw $v0 8($t0)
	...
	la $t1 function_IO_out_string
	sw $t1 24($v0)
	la $t1 function_BookList_isNil
	sw $t1 28($v0)
	la $t1 function_BookList_cons
	sw $t1 32($v0)
	la $t1 function_BookList_car
	sw $t1 36($v0)
	la $t1 function_BookList_cdr
	sw $t1 40($v0)
	la $t1 function_BookList_print_list
	sw $t1 44($v0)
	lw $t0 40($s0)
	sw $v0 8($t0)
