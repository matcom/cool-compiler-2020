...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var27<-['Main', 'out_string']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a1, 0($sp)
lw $a0, 4($sp)
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var31<-['Main', 'in_int']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a0, 0($sp)
addi $sp, $sp, 4
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var33<-['Main', 'out_int']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a1, 0($sp)
lw $a0, 4($sp)
...
addi $sp, $sp, -4
sw $ra, 0($sp)
jalr $ra,$t0 #var.var36<-['Main', 'out_string']
lw $ra, 0($sp)
addi $sp, $sp, 4
lw $a1, 0($sp)
lw $a0, 4($sp)
