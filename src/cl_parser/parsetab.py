...
_lr_productions = [
  ...
  ('expr -> ID ASSIGN expr','expr',3,'p_expr','config.py',86),
  ('expr -> arith','expr',1,'p_expr','config.py',87),
  ('let_list -> let_assign','let_list',1,'p_let_list','config.py',103),
  ('let_list -> let_assign COMMA let_list','let_list',3,'p_let_list','config.py',104),
  ('let_assign -> param ASSIGN expr','let_assign',3,'p_let_assign','config.py',111),
  ('let_assign -> param','let_assign',1,'p_let_assign','config.py',112),
  ('cases_list -> case SEMI','cases_list',2,'p_cases_list','config.py',121),
  ('cases_list -> case SEMI cases_list','cases_list',3,'p_cases_list','config.py',122),
  ('case -> ID COLON ID WITH expr','case',5,'p_case','config.py',129),
  ('arith -> arith PLUS arith','arith',3,'p_arith_binary','config.py',145),
  ('arith -> arith MINUS arith','arith',3,'p_arith_binary','config.py',146),
  ('arith -> arith STAR arith','arith',3,'p_arith_binary','config.py',147),
  ('arith -> arith DIVIDE arith','arith',3,'p_arith_binary','config.py',148),
  ('arith -> arith LESS arith','arith',3,'p_arith_binary','config.py',149),
  ('arith -> arith LESSQ arith','arith',3,'p_arith_binary','config.py',150),
  ('arith -> arith EQUALS arith','arith',3,'p_arith_binary','config.py',151),
  ('arith -> BITNOT arith','arith',2,'p_arith_unary','config.py',168),
  ('arith -> ISVOID arith','arith',2,'p_arith_unary','config.py',169),
  ('arith -> NOT arith','arith',2,'p_arith_unary','config.py',170),
  ('arith -> base_call','arith',1,'p_arith_basecall','config.py',179),
  ('base_call -> fact ARROBA ID DOT func_call','base_call',5,'p_basecall','config.py',185),
  ('base_call -> fact','base_call',1,'p_basecall','config.py',186),
  ('fact -> fact DOT func_call','fact',3,'p_factcall','config.py',193),
  ('fact -> func_call','fact',1,'p_factcall','config.py',194),
  ('func_call -> ID LPAREN arg_list RPAREN','func_call',4,'p_func_call','config.py',201),
  ('arg_list -> empty','arg_list',1,'p_arglist','config.py',205),
  ('arg_list -> expr','arg_list',1,'p_arglist','config.py',206),
  ('arg_list -> expr COMMA arg_list','arg_list',3,'p_arglist','config.py',207),
  ('fact -> LPAREN expr RPAREN','fact',3,'p_factatom','config.py',219),
  ('fact -> atom','fact',1,'p_factatom','config.py',220),
  ('atom -> INTEGER','atom',1,'p_atom_int','config.py',227),
  ('atom -> ID','atom',1,'p_atom_id','config.py',231),
  ('atom -> NEW ID','atom',2,'p_atom_new','config.py',235),
  ('atom -> LBRACE block RBRACE','atom',3,'p_atom_block','config.py',239),
  ('block -> expr SEMI','block',2,'p_block','config.py',243),
  ('block -> expr SEMI block','block',3,'p_block','config.py',244),
  ('atom -> BOOL','atom',1,'p_atom_bool','config.py',251),
  ('atom -> STRING','atom',1,'p_atom_string','config.py',255),
]
