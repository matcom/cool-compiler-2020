...
_lr_productions = [
  ...
  ('def_class -> class id ocur feature_list ccur semi','def_class',6,'p_def_class','cool_grammar.py',26),
  ('def_class -> class id inherits id ocur feature_list ccur semi','def_class',8,'p_def_class','cool_grammar.py',27),
  ('feature_list -> epsilon','feature_list',1,'p_feature_list','cool_grammar.py',34),
  ('feature_list -> def_attr semi feature_list','feature_list',3,'p_feature_list','cool_grammar.py',35),
  ('feature_list -> def_func semi feature_list','feature_list',3,'p_feature_list','cool_grammar.py',36),
  ('def_attr -> id colon id','def_attr',3,'p_def_attr','cool_grammar.py',48),
  ('def_attr -> id colon id larrow expr','def_attr',5,'p_def_attr','cool_grammar.py',49),
  ('def_func -> id opar param_list cpar colon id ocur expr ccur','def_func',9,'p_def_func','cool_grammar.py',56),
  ('param_list -> param','param_list',1,'p_param_list','cool_grammar.py',60),
  ('param_list -> param comma param_list','param_list',3,'p_param_list','cool_grammar.py',61),
  ('param_list -> epsilon','param_list',1,'p_param_list_empty','cool_grammar.py',68),
  ('param -> id colon id','param',3,'p_param','cool_grammar.py',72),
  ('expr -> let let_list in expr','expr',4,'p_expr_let','cool_grammar.py',76),
  ('expr -> case expr of cases_list esac','expr',5,'p_expr_case','cool_grammar.py',80),
  ('expr -> if expr then expr else expr fi','expr',7,'p_expr_if','cool_grammar.py',84),
  ('expr -> while expr loop expr pool','expr',5,'p_expr_while','cool_grammar.py',88),
  ('expr -> arith','expr',1,'p_expr_arith','cool_grammar.py',92),
  ('let_list -> let_assign','let_list',1,'p_let_list','cool_grammar.py',97),
  ('let_list -> let_assign comma let_list','let_list',3,'p_let_list','cool_grammar.py',98),
  ('let_assign -> param larrow expr','let_assign',3,'p_let_assign','cool_grammar.py',105),
  ('let_assign -> param','let_assign',1,'p_let_assign','cool_grammar.py',106),
  ('cases_list -> casep semi','cases_list',2,'p_cases_list','cool_grammar.py',114),
  ('cases_list -> casep semi cases_list','cases_list',3,'p_cases_list','cool_grammar.py',115),
  ('casep -> id colon id rarrow expr','casep',5,'p_case','cool_grammar.py',122),
  ('arith -> id larrow expr','arith',3,'p_arith','cool_grammar.py',127),
  ('arith -> not comp','arith',2,'p_arith','cool_grammar.py',128),
  ('arith -> comp','arith',1,'p_arith','cool_grammar.py',129),
  ('comp -> comp less op','comp',3,'p_comp','cool_grammar.py',139),
  ('comp -> comp lesseq op','comp',3,'p_comp','cool_grammar.py',140),
  ('comp -> comp equal op','comp',3,'p_comp','cool_grammar.py',141),
  ('comp -> op','comp',1,'p_comp','cool_grammar.py',142),
  ('op -> op plus term','op',3,'p_op','cool_grammar.py',154),
  ('op -> op minus term','op',3,'p_op','cool_grammar.py',155),
  ('op -> term','op',1,'p_op','cool_grammar.py',156),
  ('term -> term star base_call','term',3,'p_term','cool_grammar.py',165),
  ('term -> term div base_call','term',3,'p_term','cool_grammar.py',166),
  ('term -> isvoid base_call','term',2,'p_term','cool_grammar.py',167),
  ('term -> nox base_call','term',2,'p_term','cool_grammar.py',168),
  ('term -> base_call','term',1,'p_term','cool_grammar.py',169),
  ('base_call -> factor arroba id dot func_call','base_call',5,'p_base_call','cool_grammar.py',182),
  ('base_call -> factor','base_call',1,'p_base_call','cool_grammar.py',183),
  ('factor -> atom','factor',1,'p_factor1','cool_grammar.py',190),
  ('factor -> opar expr cpar','factor',3,'p_factor1','cool_grammar.py',191),
  ('factor -> factor dot func_call','factor',3,'p_factor2','cool_grammar.py',198),
  ('factor -> func_call','factor',1,'p_factor2','cool_grammar.py',199),
  ('atom -> num','atom',1,'p_atom_num','cool_grammar.py',206),
  ('atom -> id','atom',1,'p_atom_id','cool_grammar.py',210),
  ('atom -> new id','atom',2,'p_atom_new','cool_grammar.py',214),
  ('atom -> ocur block ccur','atom',3,'p_atom_block','cool_grammar.py',218),
  ('atom -> true','atom',1,'p_atom_boolean','cool_grammar.py',222),
  ('atom -> false','atom',1,'p_atom_boolean','cool_grammar.py',223),
  ('atom -> string','atom',1,'p_atom_string','cool_grammar.py',227),
  ('block -> expr semi','block',2,'p_block','cool_grammar.py',231),
  ('block -> expr semi block','block',3,'p_block','cool_grammar.py',232),
  ('func_call -> id opar arg_list cpar','func_call',4,'p_func_call','cool_grammar.py',239),
  ('arg_list -> expr','arg_list',1,'p_arg_list','cool_grammar.py',243),
  ('arg_list -> expr comma arg_list','arg_list',3,'p_arg_list','cool_grammar.py',244),
  ('arg_list -> epsilon','arg_list',1,'p_arg_list_empty','cool_grammar.py',251),
]
