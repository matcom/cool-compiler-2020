...
class DefaultErrorStrategy(ErrorStrategy):
    ...
    def reportInputMismatch(self, recognizer:Parser, e:InputMismatchException):
        msg = "SyntacticError" 
         #self.getTokenErrorDisplay(e.offendingToken) \ + " expecting " + e.getExpectedTokens().toString(recognizer.literalNames, recognizer.symbolicNames)
        recognizer.notifyErrorListeners(msg, e.offendingToken, e)
    ...
    def reportUnwantedToken(self, recognizer:Parser):
        ...
        msg = "SyntacticError" 
        #+ tokenName + " expecting "+expecting.toString(recognizer.literalNames, recognizer.symbolicNames)
