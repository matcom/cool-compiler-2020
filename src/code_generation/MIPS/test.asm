...
List_cons:
	...
	lw         $t0, -20($fp)
	sw         $t0, -24($fp)
	#          local_6 = GETTYPEADDR new_cell ;
	lw         $t1, -24($fp)
	lw         $t0, 8($t1)
	sw         $t0, -28($fp)
	#          local_7 = VCALL local_6 init ;
	subu       $sp, $sp, 8
	sw         $fp, 0($sp)
	sw         $ra, 4($sp)
	#          ARG new_cell ;
...
Cons_insert:
	...
	la         $t0, vt_Cons
	sw         $t0, 8($v0)
	#          local_11 = LOAD data_2 ;
	la         $t0, data_2
	sw         $t0, -48($fp)
	#          SETATTR local_10 @type local_11 ;
	lw         $t0, -48($fp)
	lw         $t1, -44($fp)
	sw         $t0, 0($t1)
	#          local_12 = 24 ;
	li         $t0, 24
	sw         $t0, -52($fp)
	#          SETATTR local_10 @size local_12 ;
	lw         $t0, -52($fp)
	lw         $t1, -44($fp)
	sw         $t0, 4($t1)
	#          local_13 = -3 ;
	li         $t0, -3
	sw         $t0, -56($fp)
	#          SETATTR local_10 @order local_13 ;
	lw         $t0, -56($fp)
	lw         $t1, -44($fp)
	sw         $t0, 12($t1)
	#          local_14 = VCALL Cons __init__ ;
	subu       $sp, $sp, 8
	sw         $fp, 0($sp)
	sw         $ra, 4($sp)
	#          ARG local_10 ;
	...
	addu       $sp, $sp, 8
	sw         $v0, -60($fp)
	#          local_9 = GETTYPEADDR local_14 ;
	lw         $t1, -60($fp)
	lw         $t0, 8($t1)
	sw         $t0, -40($fp)
	#          local_15 = GETATTR self xcar ;
	lw         $t0, 4($fp)
	lw         $t1, 16($t0)
	sw         $t1, -64($fp)
	#          local_17 = GETATTR self xcdr ;
	lw         $t0, 4($fp)
	lw         $t1, 20($t0)
	sw         $t1, -72($fp)
	...
	lw         $t0, 8($t1)
	sw         $t0, -68($fp)
	#          local_18 = VCALL local_16 insert ;
	subu       $sp, $sp, 8
	sw         $fp, 0($sp)
	sw         $ra, 4($sp)
	#          ARG local_17 ;
	...
	li         $t0, -3
	sw         $t0, -28($fp)
	#          SETATTR local_3 @order local_6 ;
	lw         $t0, -28($fp)
	lw         $t1, -16($fp)
	sw         $t0, 12($t1)
	#          local_7 = VCALL Cons __init__ ;
	subu       $sp, $sp, 8
	sw         $fp, 0($sp)
	sw         $ra, 4($sp)
	#          ARG local_3 ;
	...
	addu       $sp, $sp, 8
	sw         $v0, -32($fp)
	#          local_2 = GETTYPEADDR local_7 ;
	lw         $t1, -32($fp)
	lw         $t0, 8($t1)
	sw         $t0, -12($fp)
	#          local_8 = VCALL local_2 init ;
	subu       $sp, $sp, 8
	sw         $fp, 0($sp)
	sw         $ra, 4($sp)
	#          ARG local_7 ;
...
Cons_rcons:
	...
	addu       $sp, $sp, 8
	sw         $v0, -24($fp)
	#          local_0 = GETTYPEADDR local_5 ;
	lw         $t1, -24($fp)
	lw         $t0, 8($t1)
	sw         $t0, -4($fp)
	#          local_6 = GETATTR self xcar ;
	lw         $t0, 4($fp)
	lw         $t1, 16($t0)
	sw         $t1, -28($fp)
	#          local_8 = GETATTR self xcdr ;
	lw         $t0, 4($fp)
	lw         $t1, 20($t0)
	sw         $t1, -36($fp)
...
Main_iota:
	...
	li         $t0, -3
	sw         $t0, -48($fp)
	#          SETATTR local_8 @order local_11 ;
	lw         $t0, -48($fp)
	lw         $t1, -36($fp)
	sw         $t0, 12($t1)
	#          local_12 = VCALL Cons __init__ ;
	subu       $sp, $sp, 8
	sw         $fp, 0($sp)
	sw         $ra, 4($sp)
	#          ARG local_8 ;
