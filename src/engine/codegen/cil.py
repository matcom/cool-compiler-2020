from .ast import ProgramNode,TypeNode,DataNode,FunctionNode,ArithmeticNode,ParamNode, \
LocalNode, AssignNode,GetAttribNode,SetAttribNode,SetIndexNode,AllocateNode,TypeOfNode, \
LabelNode,GotoNode,IfGotoNode,StaticCallNode,DynamicCallNode,ArgNode,ReturnNode,LoadNode, \
LengthNode,ConcatNode,PrefixNode,SubstringNode,ToStrNode,ToIntNode,ReadNode,PrefixNode
...
class BASE_COOL_CIL_TRANSFORM:
    ...
    def build_basic_string(self):
        ...
        self.register_instruction(IfGotoNode(cmp_var1, no_error_label1))
        ...
        self.register_instruction(IfGotoNode(cmp_var2, no_error_label2))
        self.register_instruction(ErrorNode())
        ...
        self.register_instruction(IfGotoNode(cmp_var3, no_error_label3))
        self.register_instruction(ErrorNode())
