...
class BaseCOOLToCILVisitor:
    ...
    def create_built_in(self):
        ...
        f11_intructions = [cil.LoadNode(f11_localVars[0].name, 'type_String', self.index),cil.ReturnNode(f11_localVars[0].name, self.index)]
        ...
        f12_intructions = [cil.LengthNode(f12_localVars[1].name, f12_params[0].name), cil.MinusNode(f12_localVars[2].name, f12_localVars[1].name, 1), cil.SubstringNode(f12_localVars[0].name, f12_params[0].name, 0, f12_localVars[2].name),cil.ReturnNode(f12_localVars[0].name, self.index)]
        ...
        f13_intructions = [cil.LoadNode(f13_localVars[0].name, 'type_Int', self.index),cil.ReturnNode(f13_localVars[0].name, self.index)]
        ...
        f14_intructions = [cil.AssignNode(f14_localVars[0].name, f14_params[0].name), cil.ReturnNode(f14_localVars[0].name, self.index)]
        ...
        f15_intructions = [cil.LoadNode(f15_localVars[0].name, 'type_Bool', self.index),cil.ReturnNode(f15_localVars[0].name, self.index)]
        ...
        f16_intructions = [cil.AssignNode(f16_localVars[0].name, f16_params[0].name), cil.ReturnNode(f16_localVars[0].name, self.index)]
        ...
        string_methods = [('length', f8.name), ('concat', f9.name), ('substr', f10.name), ('abort', f1.name), ('type_name', f11.name), ('copy', f12.name)]
        io_methods = [('out_string', f4.name), ('out_int', f5.name), ('in_int', f6.name), ('in_string', f7.name)]
        int_methods = [('abort', f1.name), ('type_name', f13.name), ('copy', f14.name)]
        bool_methods = [('abort', f1.name), ('type_name', f15.name), ('copy', f16.name)]
